...
reDict = {'TSLA' : r'(\bт[еэ]сл.{1,2}\b|\bte?sla.{0,1}\b)', 'SBER.ME' : r'(\bсбер[ -]?банк.{0,2}\b|\bсбер.{0,2}\b|\bSBER.*\b)', 'GAZP.ME' : r'(\bгаз[ -]?пром.{0,2}\b|\bgaz[ -]?p.{0,3}\b)', 'LKOH.ME' : r'(\bлуко[йи]л.{0,2}\b|\blukoil.{0,2}\b|\blkoh\b|\blkoh\.me\b)', 'VTBR.ME' : r'(\bвтб.{0,2}\b|\bvtb.{0,2}\b|\bVTBR\.ME\b)', 'ROSN.ME' : r'(\bроснефт.{0,2}\b|\brosn.*\b|\bROSN\.ME\b)', 'GMKN.ME' : r'(\bнор.*[ -]?никел.{1,3}\b|\bgmkn\b|\bGMKN\.ME\b)', 'CHMF.ME' : r'(\bсеверстал.{0,2}\b|\bchmf\b|\bCHMF\.ME\b)', 'YNDX.ME' : r'(\bяндекс.{0,2}\b|\by[a]?nd[e]?x\b|\bYNDX\.ME\b)', 'SNGSP.ME' : r'(\bсургут[ -]?нефте[ -]?газ.{0,2}\b|\bSNGSP\.ME\b)', 'MGNT.ME' : r'(\bмагнит.{0,2}\b|\bm[a]?gn[i]?t\b|\bMGNT\.ME\b)', 'TATN.ME' : r'(\bтат[ -]?нефт.{0,2}\b|\btatn.*\b|\bTATN\.ME\b)', 'TRNFP.ME' : r'(\bтранс[ -]?нефт.{0,2}\b|\btrnfp\b|\btrans[ -]?neft\b|\bTRNFP\.ME\b)', 'OZON.ME' : r'(\bозон.{0,2}\b|\bozon.{0,2}\b|\bOZON\.ME\b)', 'TCSG.ME' : r'(\bтинько.{1,3}\b|\btinkoff.{0,2}\b|\bTCS[g]\b|\bTCSG\.me\b)', 'MAIL.ME' : r'(\bмэ[ий]л.{0,2}\b|\bmail[\.]?.{0,2}\b|\bMAIL\.ME\b)', 'AAPL' : r'(\bэп[п]?л.{0,2}\b|\bap[p]?le\b|\bяблок.{1,2}\b\bAAPL\b)', 'AMZN' : r'(\bамазон.{0,2}\b|\bamazo.{1,2}\b|\bAMZN\b)', 'ALRS.ME' : r'(\bALROS.{1,2}\b|\bалрос.{1,2}\b|\bALRS\.ME\b)', 'GME' : r'(\bgame[ -]?stop.{0,1}\b|\bгейм[ -]?стоп.{0,2}\b|\bGME\b)', 'BAC' : r'(bank of america|бэнк оф Америк.{1,2}|\bБанк.{0,2} Америки\b|\bBAC\b)', 'NIO' : r'(\bnio.{0,1}\b|\bнио\b)', 'MSFT' : r'(\bMSFT\b|\bMicrosoft\b|\bмикро[ -]?софт\b|\bмайкро[ -]?софт\b)', 'FB' : r'(\bFB\b|\bfacebook\b|\bфб\b|\bф[еэ]йс[ -]?бук.{0,2}\b)', 'BABA' : r'(\bBABA\b|\bali[ -]baba\b|\bали[ -]?баба\b)', 'NVDA' : r'(\bnv[i]?d[i]?a\b|\b[э]?нвидиа\b)', 'NFLX' : r'(\bNFLX\b|\bnetflix.{0,2}\b|\bн[еэ]тфлик.{0,3}\b)', 'ZM' : r'(\bZoom.{0,2}\b|\bzm\b|\bзум.{0,2}\b)', 'MRNA' : r'(\bMRNA\b|\bmoderna\b|\bмодерн.{1,2}\b)', 'F' : r'(\bF\b|\bford.{0,2}\b|\bфорд.{0,2}\b)', 'PFE' : r'(\bPFE\b|\bPfizer.{0,2}\b|\bпфизер.{0,2}\b|\b[п]?файзер.{0,2}\b)'}
